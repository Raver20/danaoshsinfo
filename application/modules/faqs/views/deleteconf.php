    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
           ...
           <?php 
                ...
                echo form_open('strands/delete/'.$update_id, $attributes); 
            ?>
            
           
                
            <button type="submit" name="submit" value="Yes - Delete Strand" class="btn btn-danger m-t-15 waves-effect">Yes - Delete Facility</button>
